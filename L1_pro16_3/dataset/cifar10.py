...
def get_cifar_iter_dali(type, image_dir='/home/xuzihan/data', batch_size=256, num_threads=4, local_rank=0, world_size=1, val_size=128, cutout=0):
    if type == 'train':
...
def get_cifar_iter_torch(type, image_dir='/home/xuzihan/data', batch_size=256, num_threads=4, cutout=0):
