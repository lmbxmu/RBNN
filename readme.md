...
By reducing the angular bias, our rotation design can be utilized to further boost the performance on the basis of existing methods, such as XNOR-Net and Bi-real structure as demonstrated in the paper. We encourage the readers to try it on more recent arts such as [ReActNet](https://arxiv.org/pdf/2003.03488.pdf), structure of which has significantly improved to the performance of binary neural network. I hadn't got a change to do it yet since this work was not publicly available before the NeurIPS submission, and now I have very limited hardware platform to support the implementation. If you have done this, please kindly contact me and inform me of your results.
