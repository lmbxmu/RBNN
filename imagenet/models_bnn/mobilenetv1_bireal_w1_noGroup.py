...
__all__=['mobilenetv1_bireal_noGroup_1w1a','mobilenetv1_bireal_025_noGroup_1w1a','mobilenetv1_bireal_05_noGroup_1w1a']
...
class Block(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1,alpha=1):
        ...
        self.conv1 = BinarizeConv2d(in_planes, in_planes, kernel_size=3, stride=stride, padding=1, bias=False)
...
def mobilenetv1_bireal_noGroup_1w1a():
    return MobileNet() 

def mobilenetv1_bireal_025_noGroup_1w1a():
    return MobileNet(alpha=0.25)
    
def mobilenetv1_bireal_05_noGroup_1w1a():
